...
* **CQRS (Command Query Responsibility Segregation)** e *Vertical Slice Architecture*.
...
Para ver a documentação técnica completa do fluxo de dados ponta a ponta, consulte o arquivo **[ARQUITETURA.md](file:///c:/Users/Hass/Documents/NewEra/Banquinho/ARQUITETURA.md)**.
...
- [ ] Próximos passos: Implementação de CQRS, Arquitetura Hexagonal, tratamento global de erros, cadastro de clientes e transações financeiras (consulte o [ROADMAP.md](file:///c:/Users/Hass/Documents/NewEra/Banquinho/ROADMAP.md)).

---

## 🗺️ Documentos de Referência

* **[ARQUITETURA.md](file:///c:/Users/Hass/Documents/NewEra/Banquinho/ARQUITETURA.md)**: Mapeamento aprofundado dos fluxos de dados ponta a ponta com diagramas de sequência Mermaid e boas práticas.
* **[ROADMAP.md](file:///c:/Users/Hass/Documents/NewEra/Banquinho/ROADMAP.md)**: Guia passo a passo das fases do projeto e análise comparativa de padrões avançados (CQRS, Hexagonal, etc.).
